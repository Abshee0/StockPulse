...
import { Settings as SettingsIcon, Users, Tags, Building2, MapPin } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center">
        ...
        <h1 className={`${theme === 'dark' ? 'text-purple-200' : 'text-gray-900'} text-2xl font-semibold text-gray-900`}>Settings</h1>
      </div>
